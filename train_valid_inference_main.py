...
if __name__ == "__main__":
    ...
    hypar["crop_size"] = [580, 480] ## random crop size from the input, it is usually set as smaller than hypar["cache_size"], e.g., [920,920] for data augmentation
    ...
    hypar["early_stop"] = 24 ## stop the training when no improvement in the past 20 validation periods, smaller numbers can be used here e.g., 5 or 10.
    hypar["model_save_fre"] = 200 ## valid and save model weights every 2000 iterations
    ...
    hypar["max_epoch_num"] = 1000 #1000000 ## if early stop and max_ite couldn't stop the training process, stop it by the max_epoch_num
